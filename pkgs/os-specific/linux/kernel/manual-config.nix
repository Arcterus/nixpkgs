    ...
    drvAttrs =
      ...
      // {
        ...
        configurePhase = ''
          ...
          make ${configfile.makeFlags} oldconfig
          runHook postConfigure

          # make "''${makeFlagsArray[@]}" prepare
          make ${configfile.makeFlags} prepare
        ...
        postInstall = optionalString isModular ''
          ...
          make modules_install ${configfile.makeFlags} \
          ...
          make modules_prepare ${configfile.makeFlags} O=$dev/lib/modules/${modDirVersion}/build
